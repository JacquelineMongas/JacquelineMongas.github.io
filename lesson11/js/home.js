...
fetch(requestURL)
    ...
    .then(function(jsonObject) {
       ...
       const preston = document.querySelector('.prestondata');
       ...
       const fishhaven = document.querySelector('.fishHavendata');
       ...
       const sodasprings = document.querySelector('.sodaSpringsdata');
